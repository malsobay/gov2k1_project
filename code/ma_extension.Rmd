...
1. Aggregation drops records that have nulls in any values, which reduces the sample size nearly 30% and limits the external validity of the results 
...
3. The tweets are riddled with unintended political messages, and tweet 2 has nothing to do with sectarianism, and the increased approval is actually from the way that the primes are phrased 
